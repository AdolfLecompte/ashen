# Generated by Powerlevel10k configuration wizard on 2026-03-31 at 18:11 -05.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=$(cat ~/.cache/caelestia-prompt-color 2>/dev/null || echo 31)
